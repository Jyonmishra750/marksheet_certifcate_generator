    ...
    <div class="alert alert-danger left-icon-alert" role="alert">
                                        ...
                                        <?php } ?>
                                            ...
                                            <table id="example" class="display table table-striped table-bordered" cellspacing="0" width="100%">
                                                    ...
                                                    <tbody>
                                                    <?php $sql = "SELECT * FROM tblresult ORDER BY id ASC";
                                                    ...
                                                    <tr>
                                                            ...
                                                            <td>
<a href="/admin/edit-result.php?subjectid=<?php echo htmlentities($result->id);?>"><i class="fa fa-edit" title="Edit Record"></i> </a> 
